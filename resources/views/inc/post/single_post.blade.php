...
<div class="stunning-header stunning-header-bg-lightviolet">
    <div class="stunning-header-content">
        <h1 class="stunning-header-title">{{$single_post->title}}</h1>
    </div>
</div>
            ...
            <div class="col-lg-10 col-lg-offset-1">
                <article class="hentry post post-standard-details">
                    ...
                    <div class="post-thumb">
                        <img src="{{asset('images/'.$single_post->feature)}}" alt="seo">
                    </div>
                    ...
                    <div class="post__content">
                        ...
                        <div class="post-additional-info">
                            ...
                            <span class="post__date">
                                ...
                                <time class="published" datetime="2016-03-20 12:00:00">
                                   {{$single_post->created_at->toFormattedDateString()}}
                                </time>
                            ...
                            <span class="category">
                                ...
                                <a href="{{route('category.post',$single_post->category->id)}}">{{$single_post->category->name}}
                                </a>                     
                            </span>
                        ...
                        <div class="post__content-info">
                            ...
                            <p class="post__subtitle">{{$single_post->title}}
                            </p>

                            <p class="post__text">{!!$single_post->content!!}
                            </p>
                            ...
                            <div class="widget w-tags">
                                <div class="tags-wrap">
                                    @if(count($single_post->tags) > 0)
                                    	@foreach($single_post->tags as $tag)
                                    		<a href="{{route('tag.post',$tag->id)}}" class="w-tags-item">{{$tag->tag}}</a>
                                    	@endforeach
                                    @endif
                                </div>
                            </div>
                    ...
                    <div class="socials text-center">
                        ...
                        <div class="addthis_inline_share_toolbox_461h"></div>
                                    
                    </div>

                </article>

                <!-- start blog detail author -->
                
                @include('inc.blog_detail_author')
                
                <!-- end blog detail author -->

                <div class="pagination-arrow">

                	@if($prev)
                	<a href="{{route('single.post',$prev->slug)}}" class="btn-prev-wrap">
                        <svg class="btn-prev">
                    ...
                    @if($next)
                     <a href="{{route('single.post',$next->slug)}}" class="btn-next-wrap">
                        <div class="btn-content">
