            ...
            <div class="col-lg-8">
                    ...
                    <article class="hentry post post-standard has-post-thumbnail sticky">
                         <div class="post-thumb">
                            <img src="{{asset('images/'.$first_post->feature)}}" alt="seo">
                          ...
                          <div class="post__content">
                            ...
                            <div class="post__content-info">
                                    ...
                                    <h2 class="post__title entry-title ">
                                        <a href="{{route('single.post',$first_post->slug)}}">{{$first_post->title}}
                                        </a>
                                    </h2>
                                    ...
                                    <div class="post-additional-info">
                                        ...
                                        <span class="category">
                                            ...
                                            <a href="{{route('category.post',$first_post->category->id)}}">{{$first_post->category->name}}</a>
                                        </span>
        ...
        <div class="row">
            ...
            @if($second_post)
                ...
                <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <div class="post-thumb">
                            <img src="{{asset('images/'.$second_post->feature)}}" alt="seo">
                            <div class="overlay"></div>
                        ...
                        <div class="post__content">
                            ...
                            <div class="post__content-info">
                                    ...
                                    <div class="post-additional-info">
                                        ...
                                        <span class="category">
                                            <i class="seoicon-tags"></i>
                                            <a href="{{route('category.post',$second_post->category->id)}}">{{$second_post->category->name}}</a>
                                        </span>
            ...
            @if($third_post)
                ...
                <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <div class="post-thumb">
                            <img src="{{asset('images/'.$third_post->feature)}}" alt="seo">
                            <div class="overlay"></div>
                        ...
                        <div class="post__content">
                            ...
                            <div class="post__content-info">
                                    ...
                                    <div class="post-additional-info">
                                        ...
                                        <span class="category">
                                            <i class="seoicon-tags"></i>
                                            <a href="{{route('category.post',$third_post->category->id)}}">{{$third_post->category->name}}</a>
                                        </span>
        ...
        <div class="row medium-padding120 bg-border-color">
            <div class="container">
                ...
                <div class="offers">
                    ...
                    <div class="row">
                        <div class="case-item-wrap">
                                @foreach($laravel->posts()->orderBy('id','desc')->take(3)->get() as $laravel)
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                <div class="case-item">
                                    <div class="case-item__thumb">
                                        <img src="{{asset('images/'.$laravel->feature)}}" alt="our case">
                                    </div>
                                    <h6 class="case-item__title"><a href="{{route('single.post',$laravel->slug)}}">{{$laravel->title}}</a></h6>
                                </div>
                            </div>
                                @endforeach
                        </div>
                ...
                <div class="offers">
                    ...
                    <div class="row">
                        <div class="case-item-wrap">
                                @foreach($css->posts()->orderBy('id','desc')->take(3)->get() as $css)
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                <div class="case-item">
                                    <div class="case-item__thumb">
                                        <img src="{{asset('images/'.$css->feature)}}" alt="our case">
                                    </div>
                                    <h6 class="case-item__title"><a href="{{route('single.post',$css->slug)}}">{{$css->title}}</a></h6>
                                </div>
                            </div>
                                @endforeach
                        </div>
               ...
               <!--  <div class="offers">
                    <div class="row">
                        <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                            <div class="heading">
                                <h4 class="h1 heading-title">css 5.3</h4>
                                <div class="heading-line">
                                    <span class="short-line"></span>
                                    <span class="long-line"></span>
                                </div>
            ...
            <div class="info">
                <div class="col-lg-6 col-lg-offset-3">
                    <div class="heading text-center">
                        <h3 class="heading-title" >{{$site_name}}</h3>
                        <div class="heading-line">
                            <span class="short-line"></span>
                            <span class="long-line"></span>
                        </div>
...
<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5c386ae76a72da55"></script>
